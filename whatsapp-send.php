...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($message_text)) {
        ...
        $success_message = '<div class="alert alert-success">
            <h4>✅ Mesajınız hazırlandı!</h4>
            <p>WhatsApp pəncərəsi açılacaq. Mesajı göndərmək üçün "Göndər" düyməsinə basın.</p>
            <p><strong>Nömrə:</strong> +380972580000</p>
        </div>';
        ...
        <div class="container">
            ...
            <div class="contact-content">
                ...
                <div class="contact-form" data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
                    <h2>💬 WhatsApp-a Mesaj Göndərin</h2>
                    <p style="color: #666; margin-bottom: 20px;">Formu doldurduqdan sonra mesajınız birbaşa WhatsApp-a göndəriləcək.</p>
